var myPixelDraw = {
    ...
    fns: {
        calcSize: function(cant) {
            ...
            console.log($("#container").position().left+$("#container").width()+'px');
            $("#color-pick").css({'left':$("#container").position().left+$("#container").width()+'px'});
        },
        reSize: function() {
            $('#sizeit').on('click', function() {
                ...
                if (newSize == 0 || newSize > 50) {
                    ...
                    alert('ingrese un nummero valido');
                    var newSize = defaultCells;
                }
        ...
        colorIt: function() {
            $(document).on('mousedown', '#container .cell', function(e) {
                ...
                // Borrar
                myPixelDraw.colorPicked='#'+$('.jscolor').val();
                //alert($('.jscolor').val());
                if (e.button == 2) {
